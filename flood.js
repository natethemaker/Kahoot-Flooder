...
//requires
console.log("booting up bots")
readline = require('readline-sync');
console.log("Required readline-sync")
console.log("loading bypasses")
...
function ads() {
  ...
  console.log("Made by NateTheMaker")
  console.log("Website: https://replit.com/@Natethemaker")
  console.log("==================\n")
}
ads()
  ...
  client.on("QuestionReady", question => {
    ...
    if (question.type == "open_ended") {
      if (usercontrolled) {
        ...
        setTimeout(() => { client.answer("https://replit.com/@natethemaker") }, getRandomInt(1, 20000));
      }
    }
